 ...
 <q-page id="savedRoutes">
    ...
    <div class="section-title">
      <div class="text-h6 q-mx-sm">
        Select one of your save routes!
      </div>
    </div>

    <div class="text-center q-pt-lg ">
      <q-btn flat round dense icon="add_circle_outline" size="30px"></q-btn>
      <div class="text-h6">Add some routes!</div>
      <div class="q-pa-md info">This is where you can add your most favorite or common journies</div>
    </div>
          ...
          <q-item>
            <q-item-section top avatar>
              ...
              <q-item-section side bottom>
                ...
                <q-btn class="q-ma-sm" color="red" label="Delete" size="sm" />
              </q-item-section>
          </q-item>
